  ...
  return (
    <div>
      ...
      >
        <IoCloseOutline
          size={40}
          className="absolute top-5 right-5 cursor-pointer hover:text-orange-600 dark:text-white transition-colors transform duration-500 text-zinc-700"
          onClick={toggleSideBar}
        />
        ...
        <div className="relative mt-14">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full bg-gray-100 rounded pl-10 py-1 pr-10 border-b-2 text-xl border-gray-200 focus:outline-none focus:border-orange-600 text-zinc-700"
          />
        </div>
